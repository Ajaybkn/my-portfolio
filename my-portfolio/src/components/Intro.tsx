...
const Intro = () => {
	...
	const name = "Ajay Singh Khangharot";
	...
	return (
		...
		>
			...
			>
				...
				<motion.h1 className="text-4xl md:text-6xl font-extrabold mb-6 flex gap-1 text-orange-400 justify-center flex-wrap tracking-wide drop-shadow-lg">
